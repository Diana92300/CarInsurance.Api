...
namespace CarInsurance.Api.Migrations
{
    ...
    [Migration("20250828083704_AddPolicyExpiration")]
    partial class AddPolicyExpiration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarInsurance.Api.Models.InsurancePolicy", b =>
                {
                    ...
                    b.ToTable("Policies", t =>
                        {
                            t.HasCheckConstraint("data_range", "[StartDate] <= [EndDate]");
                        });
                });
            ...
            modelBuilder.Entity("CarInsurance.Api.Models.PolicyExpiration", b =>
                {
                    ...
                    b.HasIndex("PolicyId", "ExpiredOn")
                        .IsUnique();

                    b.ToTable("PolicyExpirationEvents");
                });
