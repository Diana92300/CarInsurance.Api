...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    public DbSet<PolicyExpiration> PolicyExpirationEvents => Set<PolicyExpiration>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<InsurancePolicy>()
                ...
                .IsRequired();
        modelBuilder.Entity<InsurancePolicy>()
                    .ToTable(t => t.HasCheckConstraint("data_range", "[StartDate] <= [EndDate]"));
        ...
        modelBuilder.Entity<PolicyExpiration>(b =>
        {
            b.HasIndex(e => new { e.PolicyId, e.ExpiredOn }).IsUnique();
        });
    }
}
...
public static class SeedData
{
    public static void EnsureSeeded(AppDbContext db)
    {
        ...
        db.Policies.AddRange(
            ...
            new InsurancePolicy { CarId = car1.Id, Provider = "Groupama", StartDate = new DateOnly(2025,1,1), EndDate = new DateOnly(2099, 12, 31) }, 
            new InsurancePolicy { CarId = car2.Id, Provider = "Allianz", StartDate = new DateOnly(2025,3,1), EndDate = new DateOnly(2025,9,30) },
            new InsurancePolicy { CarId = car2.Id, Provider = "TestProvider", StartDate = DateOnly.FromDateTime(DateTime.Today.AddMonths(-1)), EndDate = DateOnly.FromDateTime(DateTime.Today) }
